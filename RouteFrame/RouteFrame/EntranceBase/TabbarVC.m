...
- (void)viewDidLoad {
    ...
    homeVC.tabBarItem.image = [[UIImage imageNamed:@"icon_home_normal"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    homeVC.tabBarItem.selectedImage = [[UIImage imageNamed:@"icon_home_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    homeVC.tabBarItem.title = @"首页";
    
    MineVC *mineVC = [[MineVC alloc]init];
    UINavigationController *mineNavi = [[UINavigationController alloc]initWithRootViewController:mineVC];
    mineVC.tabBarItem.image = [[UIImage imageNamed:@"icon_me_normal"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    mineVC.tabBarItem.selectedImage = [[UIImage imageNamed:@"icon_me_press"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
